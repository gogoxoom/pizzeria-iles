...
<template>
    <section class="pb-12 pt-24" style="background-color: #ffffff;">
        <div class="container mx-auto px-4 space-y-12">
            <div class="flex flex-wrap -mx-4  items-center">
                <div class="p-4 w-full lg:w-6/12">
                    <h2 class="mb-2 text-2xl text-primary-500">Welcom to Pizzeria</h2>
                    <h3 class="font-bold mb-2 text-4xl text-gray-900">Indulge Yourself With the Delicacy of Our
                            Pizza</h3>
                    <p class="mb-6">Phasellus pulvinar faucibus neque, nec rhoncus nunc ultrices sit amet. Lorem
                            ipsum dolor sit amet, consectetur adipiscing elit. Phasellus pulvinar faucibus neque, nec
                            rhoncus nunc ultrices sit amet. Curabitur ac sagittis neque, vel egestas est.</p>
                    <a href="#" class="bg-primary-500 hover:bg-primary-600 inline-block m-1 px-6 py-2 rounded text-white">Learn
                            More</a>
                </div>
                <div class="p-4 w-full lg:w-6/12">
